...
| **[What is proven](docs/PROVEN.md)** | the engineering log — what has been run and measured, what broke, the sixty-seven defects twenty-two audits found, and the traps in the emulator core |
