...
| **[What is proven](docs/PROVEN.md)** | the engineering log — what has been run and measured, what broke, the seventy-two defects twenty-three audits found, and the traps in the emulator core |
