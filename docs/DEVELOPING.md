...
flowchart LR
    ...
    H --> T["./run-tests<br/>935 behaviour tests"]
...
935 tests in 27 files, and what each file is about says more than the count:
...
| `world.mjs` | 25 | reading a cartridge's own maps: sizes, warps, objects and triggers |
...
| `romdata.mjs` | 88 | the cartridge's own character encoding and tables, byte by byte |
...
```mermaid
flowchart BT
    C["the app"] --> T["./run-tests<br/>935 behaviour tests"]
