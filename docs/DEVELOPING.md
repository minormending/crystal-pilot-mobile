...
flowchart LR
    ...
    H --> T["./run-tests<br/>612 behaviour tests"]
...
612 tests in 23 files, and what each file is about says more than the count:
...
```mermaid
flowchart BT
    C["the app"] --> T["./run-tests<br/>612 behaviour tests"]
