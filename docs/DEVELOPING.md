...
flowchart LR
    ...
    H --> T["./run-tests<br/>963 behaviour tests"]
...
963 tests in 27 files, and what each file is about says more than the count:
...
```mermaid
flowchart BT
    C["the app"] --> T["./run-tests<br/>963 behaviour tests"]
