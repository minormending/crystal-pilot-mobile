...
flowchart LR
    ...
    H --> T["./run-tests<br/>696 behaviour tests"]
...
696 tests in 26 files, and what each file is about says more than the count:
...
```mermaid
flowchart BT
    C["the app"] --> T["./run-tests<br/>696 behaviour tests"]
