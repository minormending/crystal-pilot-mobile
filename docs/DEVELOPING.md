...
flowchart LR
    ...
    H --> T["./run-tests<br/>909 behaviour tests"]
...
909 tests in 27 files, and what each file is about says more than the count:

| file | tests | what it pins down |
| --- | --- | --- |
| `journey.mjs` | 163 | the walking: routes, doors, shut legs, healers, gyms, and the map graph |
| `rows.mjs` | 141 | what every row and offer says, when its button works, and what the runner picks |
...
```mermaid
flowchart BT
    C["the app"] --> T["./run-tests<br/>909 behaviour tests"]
