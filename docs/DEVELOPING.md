...
flowchart LR
    ...
    H --> T["./run-tests<br/>905 behaviour tests"]
...
905 tests in 27 files, and what each file is about says more than the count:
...
```mermaid
flowchart BT
    C["the app"] --> T["./run-tests<br/>905 behaviour tests"]
