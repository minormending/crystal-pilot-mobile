...
flowchart LR
    ...
    H --> T["./run-tests<br/>775 behaviour tests"]
...
775 tests in 26 files, and what each file is about says more than the count:
...
```mermaid
flowchart BT
    C["the app"] --> T["./run-tests<br/>775 behaviour tests"]
